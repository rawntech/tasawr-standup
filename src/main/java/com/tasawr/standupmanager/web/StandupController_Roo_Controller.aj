...
privileged aspect StandupController_Roo_Controller {
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String StandupController.create(@Valid Standup standup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String StandupController.createForm(Model uiModel) {
        populateEditForm(uiModel, new Standup());
        return "standups/create";
    }
    
    @RequestMapping(value = "/{id}", produces = "text/html")
    public String StandupController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String StandupController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String StandupController.update(@Valid Standup standup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, standup);
    ...
    public String StandupController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, Standup.findStandup(id));
        return "standups/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String StandupController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void StandupController.addDateTimeFormatPatterns(Model uiModel) {
